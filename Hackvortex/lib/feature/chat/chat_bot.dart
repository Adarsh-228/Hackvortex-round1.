...
class _ChatBotState extends State<ChatBot> {
  ...
  Future<String> _sendMessageToBot(String text) async {
    const apiKey = 'AIzaSyB4kcWMemFLQ8dkJqgdTsOmN1NN5pwO30o'; // Replace with your API key
    const url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent';

    try {
      // Create a prompt that includes pregnancy week context
      final prompt = '''
      System: You are a friendly and knowledgeable pregnancy assistant. Provide helpful, accurate, and supportive information. The user is currently at week $_pregnancyWeek of pregnancy.
