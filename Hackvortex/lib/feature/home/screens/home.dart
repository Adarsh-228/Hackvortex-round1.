...
class _HomeState extends State<Home> {
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      ...
      _currentPregnancyWeek = prefs.getInt('pregnancyWeek') ?? 1; // Load from SharedPreferences
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        setState(() {
                          _currentPregnancyWeek = week;
                          _updateBabyInfoForWeek(week);
                        });
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: isCurrentWeek ? kHomePrimaryColor : Colors.grey.shade200,
                        ),
                        child: Center(
                          child: Text(
                            week.toString(),
                            style: GoogleFonts.roboto(
                              color: isCurrentWeek ? Colors.white : kHomeSecondaryTextColor,
